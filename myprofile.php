        ...
        <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
              <div class="navbar-nav ms-auto py-0">
                ...
                <a href="" class="btn btn-primary rounded-pill py-2 px-4">My Profile</a>
            </div>
        </nav>
...
<!-- edit profile container -->
    <div class="container-xl px-4 mt-4">
        ...
        <nav class="nav nav-borders">
            <a class="nav-link active ms-0" href="myprofile.html" target="__blank">Personal Information</a>
            <!-- <a class="nav-link" href="profilehealth.html" target="__blank">Health Information</a>
            <a class="nav-link" href="profilebehave.html" target="__blank">Behavioural Information</a>
            <a class="nav-link" href="profilefeed.html" target="__blank">Feeding Information</a>
            <a class="nav-link" href="profileexercise.html" target="__blank">Exercise Information</a> <br> -->
            <a class="nav-link" href="profileowner.html" target="__blank">Owner Information</a>
            <a class="nav-link" href="profilesecurity.html" target="__blank">Security</a>
            <a class="nav-link" href="profilenotif.html"  target="__blank">Notifications</a>
        </nav>
        <hr class="mt-0 mb-4">
        <div class="row">
  ...
  <div class="card-body">
      <form id="profileForm">
          ...
          <div class="row gx-3 mb-3">
              ...
              <div class="col-md-6">
                  <label class="small mb-1" for="inputEmailAddress">Weight</label>
                  <input class="form-control" id="inputEmailAddress" type="email" >
                  </div>
              <!-- Form Group (birthday)-->
              <div class="col-md-6">
                  <label class="small mb-1" for="inputBirthday">Any distinguishing marks or features</label>
          ...
          <div class="container2">
            ...
            <div class="alert">Your message has been sent</div>
                  ...
                  <div class="card-body">
                      <form>
                          ...
                          <div class="row gx-3 mb-3">
                              ...
                              <!-- Form Group (last name)-->
                              <div class="col-md-6">
                                  <label class="small mb-1" for="vaccinationtype">Type of Vaccination</label>
                                  <input class="form-control" id="vaccinationtype" type="text" >
                              </div>
                              <div class="col-md-6">
                                  <label class="small mb-1" for="inputLastName">Date of Vaccination</label>
                          ...
                          <div class="mb-3">
                            <label class="small mb-1" for="medcondition">Any medical conditions or allergies</label>
                            <input class="form-control" id="medcondition" type="text"  >
                          </div>

                          <div class="mb-3">
                            <label class="small mb-1" for="medication">Any ongoing medication or treatments</label>
                            <input class="form-control" id="medication" type="text"  >
                          </div>

                          <div class="mb-3">
                            <label class="small mb-1" for="emergencycon">Emergency contact information for the veterinarian</label>
                            <input class="form-control" id="emergencycon" type="text"  >
                          </div>
              ...
              <!-- 3rd area start-->
               ...
               <div class="card mb-4">
                <div class="card-header">Behavioural Information</div>
                <div class="card-body">
                    <form>
                        <!-- Form Group (username)-->
                        <div class="mb-3">
                          <label class="small mb-1" for="temperament">Temperament</label>
                          <select class="form-control" id="temperament" type="text">
                        ...
                        <div class="mb-3">
                          <label class="small mb-1" for="behavioral">Any behavioral issues</label>
                          <select class="form-control" id="behavioral" type="text" >
...
\
              ...
              <!-- 4th area start -->
               ...
               <div class="card mb-4">
                <div class="card-header">Feeding Information</div>
                <div class="card-body">
                    <form>
                        <!-- Form Group (username)-->
                        <div class="mb-3">
                          <label class="small mb-1" for="food">Type of food</label>
                          <input class="form-control" id="food" type="text"  >
                        </div>

                        <div class="mb-3">
                          <label class="small mb-1" for="feedsch">Feeding schedule</label>
                          <input class="form-control" id="feedsch" type="text"  >
                        </div>

                        <div class="mb-3">
                          <label class="small mb-1" for="dietrest">Any dietary restrictions</label>
                          <input class="form-control" id="dietrest" type="text"  >
                        </div>
              ...
              <!-- 5th area start -->
               ...
               <div class="card mb-4">
                ...
                <div class="card-body">
                    <form>
                      <div class="mb-3">
                        <label class="small mb-1" for="exeramt">Amount of exercise needed per day</label>
                        <input class="form-control" id="exeramt" type="text"  >
                      </div>

                      
                      <div class="mb-3">
                        <label class="small mb-1" for="behavioral">Types of exercise preferred</label>
                        <select class="form-control" id="behavioral" type="text" >
